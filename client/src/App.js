...
import "./App.css";
import ReceiveAutoDealer from "./pages/AutoDealer/ReceiveAutoDealer";
import PurchaseCustomer from "./pages/Customer/PurchaseCustomer";
import ShipAutoDealer from "./pages/AutoDealer/ShipAutoDealer";
import ReceivelogisticsCompany from "./pages/logisticsCompany/ReceivelogisticsCompany";
import ShiplogisticsCompany from "./pages/logisticsCompany/ShiplogisticsCompany";
...
import PurchaseAutoDealer from "./pages/AutoDealer/PurshaseAutoDealer";
        ...
        >
          <Router history={createBrowserHistory()}>
            <Switch>
              ...
              <Route exact path="/AutoDealer/allProducts">
                {tpRole !== "" ? (
                  <PurchaseAutoDealer
                    accounts={accounts}
                    supplyChainContract={contract}
              ...
              <Route exact path="/AutoDealer/receive">
                {tpRole !== "" ? (
                  <ReceiveAutoDealer
                    accounts={accounts}
                    supplyChainContract={contract}
              ...
              <Route exact path="/AutoDealer/ship">
                {tpRole !== "" ? (
                  <ShipAutoDealer
                    accounts={accounts}
                    supplyChainContract={contract}
              ...
              <Route exact path="/logisticsCompany/receive">
                {dhRole !== "" ? (
                  <ReceivelogisticsCompany
                    accounts={accounts}
                    supplyChainContract={contract}
                  />
                ) : (
                  <h1>Assign logistics Company Role at /RoleAdmin</h1>
                )}
              </Route>
              <Route exact path="/logisticsCompany/ship">
                {dhRole !== "" ? (
                  <ShiplogisticsCompany
                    accounts={accounts}
                    supplyChainContract={contract}
                  />
                ) : (
