            ...
            {prod.length === 0 ? (
              ...
              <>
                ...
                <div>
                  ...
                  <div className={classes.dRow}>
                    <div className={classes.dCol1}>Auto Dealer Address: </div>{" "}
                    <div className={classes.dCol2}>{prod[1][6]}</div>
                  </div>
                  <div className={classes.dRow}>
                    <div className={classes.dCol1}>Auto Dealer Longitude: </div>{" "}
                    <div className={classes.dCol2}>{prod[1][7]}</div>
                  </div>
                  <div className={classes.dRow}>
                    <div className={classes.dCol1}>Auto Dealer Latitude: </div>{" "}
                    <div className={classes.dCol2}>{prod[2][0]}</div>
                  </div>

                  <div className={classes.dRow}>
                    <div className={classes.dCol1}>logistics Company Address:</div>{" "}
                    <div className={classes.dCol2}> {prod[2][1]}</div>
                  </div>
                  <div className={classes.dRow}>
                    <div className={classes.dCol1}>
                      logistics Company Longitude:{" "}
                    </div>{" "}
                    <div className={classes.dCol2}>{prod[2][2]}</div>
                  </div>
                  <div className={classes.dRow}>
                    <div className={classes.dCol1}>logistics Company Latitude:</div>{" "}
